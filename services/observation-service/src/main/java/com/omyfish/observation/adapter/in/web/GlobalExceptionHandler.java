 ...
 * clean JSON (e.g. {@code ObservationController}'s not-found handler), so callers get a
 * structured 500 instead of Spring Boot's default unstructured error response
 ...
 * first and turn e.g. a missing-header 400 into a generic 500 — confirmed by
 * {@code ObservationControllerTest#createObservation_missingUserIdHeader_returns400} actually
 * failing that way before this base class was added.
 *
